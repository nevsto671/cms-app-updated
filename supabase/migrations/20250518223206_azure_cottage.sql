/*
  # Add Super Administrator Role

  1. Changes
    - Grants super_admin role to admin@nevsto.com
    - Ensures user exists before granting role
    - Adds necessary RLS policies for super admin access
